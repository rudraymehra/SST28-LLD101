...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        MetricsRegistry global = MetricsRegistry.fetchInstance();

        System.out.println("Loaded metricsStore instance  : " + System.identityHashCode(loaded));
        System.out.println("Global metricsStore instance  : " + System.identityHashCode(global));
